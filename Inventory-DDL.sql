...
CONSTRAINT PK_Integer PRIMARY KEY (City_ID),
...
CONSTRAINT FK_Customer_Country FOREIGN KEY (Cust_Country) REFERENCES COUNTRY_T (Code)
);
...
CONSTRAINT FK_Product_Cntry_Origin FOREIGN KEY (Cntry_Origin) REFERENCES COUNTRY_T (Code)
);
